...
class LdapWebsocket(AsyncJsonWebsocketConsumer):
    ...
    def get_ldap_config(self, serializer):
        if self.category == 'ldap':
            ...
            password = serializer.validated_data["AUTH_LDAP_BIND_PASSWORD"] or settings.AUTH_LDAP_BIND_PASSWORD
            ...
            server_uri = serializer.validated_data["AUTH_LDAP_HA_SERVER_URI"]
            bind_dn = serializer.validated_data["AUTH_LDAP_HA_BIND_DN"]
            password = serializer.validated_data["AUTH_LDAP_HA_BIND_PASSWORD"] or settings.AUTH_LDAP_HA_BIND_PASSWORD
            use_ssl = serializer.validated_data.get("AUTH_LDAP_HA_START_TLS", False)
            search_ou = serializer.validated_data["AUTH_LDAP_HA_SEARCH_OU"]
            search_filter = serializer.validated_data["AUTH_LDAP_HA_SEARCH_FILTER"]
            attr_map = serializer.validated_data["AUTH_LDAP_HA_USER_ATTR_MAP"]
            auth_ldap = serializer.validated_data.get('AUTH_LDAP_HA', False)
